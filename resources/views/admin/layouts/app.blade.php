...
<div id="main-wrapper">
    ...
    <header class="topbar">
        <nav class="navbar top-navbar navbar-expand-md navbar-dark">
            <div style="background-color: #ffbc34" class="navbar-header">
                ...
                <a class="navbar-brand" href="/admin">
                    ...
                    <b class="logo-icon">
                        ...
                        <img src="/admin_template/assets/images/wpp2.png" alt="homepage" class="light-logo" />
                    </b>

                    <span class="logo-text">

                             <img src="/admin_template/assets/images/pp2.png" class="light-logo" alt="homepage" />
                        </span>
                </a>
                ...
                <ul class="navbar-nav float-right">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                            ...
                            <div style="background-color: #ffbc34" class="d-flex no-block align-items-center p-15   m-b-10">
