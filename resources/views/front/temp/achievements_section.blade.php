<section class="small-section" id="achievements-section">
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="statistic"><p class="lead"><i class="fas fa-star"></i>امتیاز ما</p>
                    <p class="count"><span class="counter" data-from="0" data-to="900">0 </span></p></div>
            </div>
            <!-- /statistics  -->                                </div>
    </div>
</section>
